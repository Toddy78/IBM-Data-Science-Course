...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(class_pie, values='class count', names='class', title=f"Success Launches for site: {entered_site}")
        return fig
# TASK 4:
...
def generate_scatter(site,payload):
    ...
    if site == 'ALL':
        ...
        fig = px.scatter(mask_filtered, 
                        ...
                        y='class', 
                        color="Booster Version Category", 
                        title=f"Correlation between Payload and Success fore {site}")
        return fig
